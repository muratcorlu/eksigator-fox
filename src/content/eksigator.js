// ==UserScript==
// @name                Eksigator
// @namespace           http://eksigator.com
// @description         Eksisözlük'te, takip ettiğiniz başlıklara, yeni bir entry girilince size haber veren bir uygulamadır. 
...
if(!GM_getValue('username')){
	GM_setValue('username', prompt('Ekşigator Kullanıcı adınız:',''));
}
var userName = GM_getValue('username');

if(!GM_getValue('apikey')){
     GM_setValue('apikey', prompt('Ekşigator API Kodunuz:',''));
}
var userApiKey = GM_getValue('apikey');
