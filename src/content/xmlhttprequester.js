function eksigator_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
eksigator_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				eksigator_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
eksigator_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
eksigator_xmlhttpRequester.prototype.setupRequestEvent =
