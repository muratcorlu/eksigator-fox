...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\denemeeklentisi on
     Windows, /home/user/dev/denemeeklentisi on Linux) in a file named
     denemeeklentisi@murat.corlu and copy that file to
